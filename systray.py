...
# messages printed.
# Modified from: https://github.com/mhammond/pywin32/blob/main/win32/Demos/win32gui_taskbar.py
import os
import win32api
import win32con
import win32gui
...
## Main App window / system tray icon
class MainWindow:
    def __init__(self):
    ...
    def _DoCreateIcons(self):
        ...
        iconPathName = 'shield-16-white.ico'
        ...
        nid = (self.hwnd, 0, flags, win32con.WM_USER + 20, hicon, "NF Guard")
        try:
    ...
    def OnTaskbarNotify(self, hwnd, msg, wparam, lparam):
        if lparam == win32con.WM_LBUTTONUP:
            ...
            win32gui.AppendMenu(menu, win32con.MF_STRING, 1023, "Edit Config")
            win32gui.AppendMenu(menu, win32con.MF_STRING, 1024, "Reload Config")
